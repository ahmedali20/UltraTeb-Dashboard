...
type Allocation = { id: number; invoice_id: string; invoice_no: string; allocated_amount: number; invoice?: { sales_date: string; due_date: string | null; customer_name: string; total_sales: number; sales_rep: string | null } };
