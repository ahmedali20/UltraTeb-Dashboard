...
type Invoice = { id: string | number; invoice_no: string; original_invoice_no?: string | null; sales_date: string; due_date: string | null; document_type: "INVOICE" | "CR_NOTE" | "DR_NOTE"; sent_to_hospital: boolean; total_sales: number; expected_wht: number; collected_wht: number; customer_payments: number; cash_fraction: number; remaining_wht: number; remaining_money: number };
...
export default function CustomerBalanceClient({ customer, invoices, customerCreditBalance, unallocatedChequeBalance, unallocatedCheques, transferFeeAdjustments }: { customer: Customer; invoices: Invoice[]; customerCreditBalance: number; unallocatedChequeBalance: number; unallocatedCheques: UnallocatedCheque[]; transferFeeAdjustments: number }) {
